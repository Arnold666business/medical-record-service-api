...
public class Mkb10DictionaryController {
    ...
    public ResponseEntity<List<Mkb10DiseaseInfoDto>>  getAllMkb10Info(){
        List<Mkb10DiseaseInfoDto> mkb10DiseaseInfoDtos = mkb10Mapper.toMkb10DiseaseInfoDtoList(mkb10DictionaryService.getAll());
        return ResponseEntity.ok().body(mkb10DiseaseInfoDtos);
    }
}
