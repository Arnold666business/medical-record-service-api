...
public class PatientPersonalInfo {
    ...
    @Size(max = LengthConstraints.MAX_LAST_NAME_LENGTH, min = LengthConstraints.MIN_LAST_NAME_LENGTH,
            message = ExceptionValidationMessages.INCORRECT_SIZE)
    @Pattern(regexp = RegexpPatterns.name_pattern, message = ExceptionValidationMessages.INCORRECT_FORMAT)
    @JsonProperty(value = "last_name")
    private String lastName;

    @NotBlank(message = ExceptionValidationMessages.NOT_BLANK)
    @Size(max = LengthConstraints.MAX_FIRST_NAME_LENGTH, min = LengthConstraints.MIN_FIRST_NAME_LENGTH,
            message = ExceptionValidationMessages.INCORRECT_SIZE)
    @Pattern(regexp = RegexpPatterns.name_pattern, message = ExceptionValidationMessages.INCORRECT_FORMAT)
    @JsonProperty(value = "first_name")
    private String firstName;

    @Size(max = LengthConstraints.MAX_MIDDLE_NAME_LENGTH,
            message = ExceptionValidationMessages.INCORRECT_SIZE)
    @Pattern(regexp = RegexpPatterns.name_pattern, message = ExceptionValidationMessages.INCORRECT_FORMAT)
    ...
    @NotBlank(message = ExceptionValidationMessages.NOT_BLANK)
    @Size(max = LengthConstraints.MAX_GENDER_LENGTH, min = LengthConstraints.MIN_GENDER_LENGTH,
            message = ExceptionValidationMessages.INCORRECT_SIZE)
    @Pattern(regexp = RegexpPatterns.name_pattern, message = ExceptionValidationMessages.INCORRECT_FORMAT)
    ...
    @NotBlank(message = ExceptionValidationMessages.NOT_BLANK)
    @Size(max = LengthConstraints.OMS_NUMBER_FIXED_LENGTH, min = LengthConstraints.OMS_NUMBER_FIXED_LENGTH,
            message = ExceptionValidationMessages.INCORRECT_SIZE)
